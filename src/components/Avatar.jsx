...
// Default options for the Adventurer style
...
const Avatar = ({ user, onAvatarSelect }) => {
  // Load persisted options from localStorage if they exist
  ...
  // New state to toggle the customizer visibility (closed initially)
  ...
  useEffect(() => {
    ...
    // Persist the current avatar options
          ...
          <div className="avatar-options-row">
            <label>
              ...
              >
                ...
                {/* Add more hair options as desired */}
              </select>
            </label>
            <label>
              Eyes:
              ...
              >
                ...
                {/* Add more eye options as desired */}
              </select>
            </label>
            <label>
              Flip:
